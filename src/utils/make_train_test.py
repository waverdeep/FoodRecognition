...
def make_train_test_dataset(directory_path):
    ...
    file_io.make_list2txt(file_list, './dataset/INGD_V2.txt')
    train_list, test_list = train_test_split(file_list, test_size=0.25)
    file_io.make_list2txt(train_list, './dataset/INGD_V2-train.txt')
    file_io.make_list2txt(test_list, './dataset/INGD_V2-test.txt')


def make_label(data_list, index=3):
    ...
    file_io.make_list2txt(label_list, './dataset/INGD_V1-category.txt')